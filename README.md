...
### Note
After starting, React should automatically redirect you to the browser with this link: http://localhost:3000/react-application since the project is uploaded to GitHub. Just remove 'react-application' from search or simply click 'Home' button to get rid of blank page.
